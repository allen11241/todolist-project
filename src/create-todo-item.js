import { loadTodoCard } from './todo-list-container';
...
function createTodoItemInput(projectKey) {
    ...
    if(priorityHigh.checked === true) {
      ...
      TodoModule.saveItemToStorage(todoItemTitle.value, todoItemDescription.value, todoItemDueDate.value, prioritySelection, projectKey)
      //const itemContainer = document.querySelector('.todo-list-container');
